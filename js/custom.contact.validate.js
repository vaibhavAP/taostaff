...
var inputs = document.querySelectorAll("form#contactform input.sm-form-control, textarea, select.sm-form-control");
...
function showErrors(form, errors) {
    ...
    form.querySelectorAll("#contactform input.sm-form-control, select.sm-form-control, textarea").forEach(function (input) {
...
function resetForm() {
    ...
    document.querySelectorAll('#contactform input.sm-form-control, select.sm-form-control, textarea').forEach(input => {
        input.value = '';
    })
}
